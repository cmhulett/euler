...
;gives 698896 as the largest palindrome product for 999 and 999,
;which is incorrect. The largest 2 numbers can't be assumed
;to create the largest product that is palindromic.
(defn false-start-largest-palindrome-product
  "Returns the largest palindrome of the product of inputs.
Decrements inputs until a palindrome is found."
  [num1 num2]
